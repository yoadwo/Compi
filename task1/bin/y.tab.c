...
static const YYINT yycheck[] = {                         -1,
    0,  264,  265,  266,  267,  291,   14,   15,    0,  295,
...
"LEFTBRACKET","RIGHTBRACKET","PERCENT",0,0,0,0,0,0,0,0,"illegal-symbol",
};
